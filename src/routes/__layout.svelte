...
<div class="mx-auto max-w-3xl px-4">
  <header class="py-4">
    <h1 class="font-bold">
      <a href="/" class="inline-flex flex-row items-center space-x-2 underline">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 102.25 122.88" class="w-6 h-6">
          <defs>
            <style>
              .a {
                fill: #ff3e00;
    ...
    <nav class="space-x-2">
      {#each links as { href, text }}
        <a {href} class="text-blue-600 hover:underline focus:underline">{text}</a>
      {/each}
    </nav>
  </header>
